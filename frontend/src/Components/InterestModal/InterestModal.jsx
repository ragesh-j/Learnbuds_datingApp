  ...
  return (
    ...
    >
      <Modal.Body className={`text-center`}>
        ...
        <Button variant="primary" className={`my-2 w-100 ${styles.btnPrimary}`} onClick={() => handleSelectInterest('male')}>MEN</Button>
        <Button variant="danger" className={`my-2 w-100 ${styles.btnDanger}`} onClick={() => handleSelectInterest('female')}>WOMEN</Button>
